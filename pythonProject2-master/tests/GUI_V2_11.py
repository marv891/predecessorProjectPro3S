...
# Form implementation generated from reading ui file 'C:\Users\louis\OneDrive\Documents\systemeTechnik\2021-2022\Pro4S\Qtdesigner\GUI_V2_1.ui'
#
...
#from FeatureControle import SetExpTime,SetGain
...
class Ui_MainWindow(object):
    def __init__(self):
        ...
        spacerItem = QtWidgets.QSpacerItem(2, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        ...
        self.textBrowser.setGeometry(QtCore.QRect(0, 0, 1091, 81))
        ...
        self.parameter_Box.setMaximumSize(QtCore.QSize(400, 16777215))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(0, 10, 291, 341))
        ...
        self.Exposure_Box.setValue(camera.f.ExposureTime.Get())
        self.Exposure_Box.setObjectName("Exposure_Box")


        exptime = self.Exposure_Box.value()
        exptime2 = self.Exposure_Time.value()
        camera.f.ExposureTime.Set(exptime)
        camera.f.ExposureTime.Set(exptime2)
        ...
        self.Gain_Box.setMaximum(10)
        self.Gain_Box.setObjectName("Gain_Box")
        gain = self.Gain.value()
        camera.f.Gain.Set(gain)
        gain2 = self.Gain.value()
        camera.f.Gain.Set(gain2)
        print(gain,gain2)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(326, 148, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        ...
        self.verticalLayout_2.addWidget(self.FeatureBox)
        self.parameter_Box.addTab(self.Parameter_BoxPage2, "")
        self.horizontalLayout.addWidget(self.parameter_Box)
        self.gridLayout.addLayout(self.horizontalLayout, 0, 0, 1, 1)
        self.VideoStream = QtWidgets.QLabel(self.centralwidget)
        self.VideoStream.setMinimumSize(QtCore.QSize(780, 691))
        self.VideoStream.setMaximumSize(QtCore.QSize(771, 695))
        ...
        #self.Exposure_Box.valueChanged['int'].connect(camera.f.ExposureTime.Set(self.Exposure_Box.value()))

        self.Gain.valueChanged['int'].connect(self.Gain_Box.setValue)

        self.Gain_Box.valueChanged['int'].connect(self.Gain.setValue)
        #self.Gain_Box.valueChanged['int'].connect(camera.f.Gain.Set(self.Gain_Box.value()))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Feature List"))
        ...
        #self.VideoStream.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><br/></p><p align=\"center\"><br/></p><p align=\"center\"><br/></p><p align=\"center\"><br/></p><p align=\"center\"><br/></p><p align=\"center\"><br/></p><p align=\"center\"><br/><br/></p><p align=\"center\"><span style=\" font-size:12pt;\">Video Output</span></p></body></html>"))
    ...
    def SetExpTime(self):
        exptime = 0
        if exptime > 40000:
            print("The chosen Exposure Time exceds current limits of 40000, Over limit")
            pass
        elif exptime < 0:
            print("The chosen Exposure Time exceds current limits of 40000, Negativ Value")
            pass
        else:
            camera.f.ExposureTime.Set(exptime)
    ...
    def SetGain(self):
        gain = 0
        if gain > 4:
            print("The chosen Gain exceds current limits of 4, Over limit")
        elif gain < 0:
            print("The chosen Gain exceds current limits of 4, Negativ Value")
        else:
            camera.f.Gain.Set(gain)
